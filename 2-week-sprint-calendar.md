...
## WIP Limits
*Maximum number of items allowed In Progress at the same time.*
...
## Sprint Backlog
*All items committed to for this sprint, pulled from the master backlog.*
...
*Items not completed this sprint that move to the next backlog.*
