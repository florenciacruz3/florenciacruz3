...
## Overview
Half Price Books is a bookstore, famous for selling used books at half price. Their website provides not only books, but movies and TV, music, collectibles, text books, games, and audiobooks. This audit 
evaluates a selection of pages against WCAG 2.1 Level AA 
success criteria using automated tools and manual testing.
